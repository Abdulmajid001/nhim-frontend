    ...
    <div className="mx-auto max-w-7xl px-5 py-7 sm:px-8 lg:px-10 lg:py-10">
      ...
      <section className="mt-6  grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
        ...
        <div className="rounded-3xl border  border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-bold text-slate-900">Recent Enrollees</h2>
            ...
            {hmoData.recentEnrollees.map((enrollee) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span className="mt-0.5 inline-block rounded bg-emerald-50 px-2 py-0.5 text-[11px] font-semibold text-emerald-700">
                    {enrollee.status}
                  </span>
                </div>
              </div>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-5 grid gap-2">
            <Link
              href="/hmo-portal/plans"
              className="flex items-center justify-between rounded-xl bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-800 transition hover:bg-slate-100"
            >
            ...
            <Link
              href="/hmo-portal/enrollees"
              className="flex items-center justify-between rounded-xl px-4 py-3 text-sm font-semibold text-slate-800 hover:bg-slate-50 transition"
            >
              <span className="flex items-center gap-3">
